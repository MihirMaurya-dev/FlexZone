            ...
            <div class="form-card">
                ...
                <form id="registerForm" onsubmit="handleRegister(event)">
                    <div class="input-box">
                        ...
                        <input type="text" id="registerUsername" name="username" placeholder="Username (min 3 chars)" required autocomplete="username" />
                    </div>
                    <div class="input-box">
                        <i class='bx bxs-envelope'></i>
                    ...
                    <div class="input-box">
                        <i class='bx bxs-lock'></i>
                        <input type="password" id="registerPassword" name="password" placeholder="Password (min 8 chars)" required autocomplete="new-password" />
                    </div>
                    <button type="submit" class="btn btn-primary">
