...
<main class="dashboard">
    <div class="live-workout-container">
        ...
        <div class="exercise-visual">
            <video autoplay loop muted playsinline id="video-player" style="max-width:100%; max-height:100%; border-radius:15px; object-fit: contain; display: none;"></video>
            <img id="visual-placeholder-img" src="../assets/exercises/placeholder.png" alt="Exercise" style="max-width:100%; max-height:100%; border-radius:15px; object-fit: contain; display: none;">
